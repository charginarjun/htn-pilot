      ...
      <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-slate-200">
        ...
        <div className="h-16 flex items-center px-6 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-bold text-slate-900">HTN Pilot</div>
        ...
        {/* Guideline version badge */}
        <div className="px-4 py-4 border-t border-slate-100">
          <div className="bg-blue-50 rounded-lg p-3">
            <div className="text-xs font-semibold text-blue-700 mb-0.5">Active Guidelines</div>
            <div className="text-xs text-blue-600">ACC/AHA 2023 · ESC 2024</div>
          </div>
        </div>
        ...
        <div className="px-4 py-4 border-t border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-medium text-slate-900 truncate">Dr. Smith</div>
              <div className="text-xs text-slate-400">Interventional Cardiology</div>
            </div>
          </div>
        </div>
      </aside>
          ...
          <div className="flex-1 max-w-md">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 rounded-lg border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-slate-50"
              />
            </div>
          </div>
